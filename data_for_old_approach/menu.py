...
def printing_main_menu():
    ...
    menu = {
        1:  print("\n")
            ...
            marco.write("Consists of natural edible bamboo charcoal which benefits health by having a cleansing effect", True,
                    align="right", font="10pt"),

        2:  print("\n"),
            marco.write("2. Ondeh Latte", True, align="right", font="10pt")
            marco.write("Mellower dancing harmoniously with traditional ingredients of Southeast Asia", True, align="right",
                    font="10pt"),
        ...
        7:  print("\n")
            marco.write("7. Indonesia, Mandheling", True, align="right", font="10pt")
        ...
        11: print("\n")
            ...
            marco.write("English Breakfast, Osmanthus, Chamomile Dream, Lemon Ginger, Mint, Straits Chai, Earl Grey Lavender",
                    True, align="right", font="10pt"),
        ...
        15: print("\n")
            ...
            marco.write("1 or 2 shots of Espresso along with a ball of energy in the form of ice cream", True, align="right",
                    font="10pt"),

        16: print("\n")
            marco.write("16. An Affair with Death", True, align="right", font="10pt")
            marco.write("A chocolate espresso that'll bring you closer to the final destination with its heavenly chocolate blend",
                     True, align="right", font="10pt"),

        15: print("\n")
            marco.write("17. Dope-Dope Doppio", True, align="right", font="10pt")
            marco.write("A double shot espresso, extracted using ta double coffee filter in the portafilter, for the two workaholics who don't care about their sleep.",
            True, align="right", font="10pt"),

        16: print("\n")
            marco.write("18. Bull Irish", True, align="right", font="10pt")
            marco.write("A cocktail consisting of hot coffee, Irish whiskey, and sugar, stirred, and topped with cream. Why should only pub goers have fun?",
            True, align="right", font="10pt"),

        17: print("\n")
            marco.write("19. Evil LATTE", True, align="right", font="10pt")
            marco.write("An espresso shot, 79 degree steamed milk, and an added delight of Bloody Mary.", True, align="right",
                    font="10pt"),

        18: print("\n")
            marco.write("20. MACHO Macchiato", True, align="right", font="10pt")
            marco.write("The shades of brown we present in our Macchiato would leave your oesophagus stained and spotted!",
                        True, align="right", font="10pt"),
        ...
        20: marco.write("22. Bull's Eye", True, align="right", font="10pt")
...
def recommended_menu():
    ...
    marco.write("16. An Affair with Death", True, align="right", font="10pt")
    marco.write(
        "A chocolate espresso that'll bring you closer to the final destination with its heavenly chocolate blend",
        True, align="right", font="10pt")

    print("\n")
    marco.write("17. Dope-Dope Doppio", True, align="right", font="10pt")
    marco.write(
        "A double shot espresso, extracted using ta double coffee filter in the portafilter, for the two workaholics who don't care about their sleep.",
        True, align="right", font="10pt")

    print("\n")
    marco.write("18. Bull Irish", True, align="right", font="10pt")
    marco.write(
        "A cocktail consisting of hot coffee, Irish whiskey, and sugar, stirred, and topped with cream. Why should only pub goers have fun?",
        True, align="right", font="10pt")
    ...
    marco.write("A shot of espresso in milk, blended perfectly in proportion to calm your mind, body and soul.", True,
                align="right", font="10pt")
